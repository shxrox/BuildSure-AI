...
function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 font-sans text-slate-800 flex flex-col lg:flex-row overflow-x-hidden selection:bg-blue-500/20">
      ...
      <div className="lg:w-1/2 relative bg-gradient-to-br from-slate-100 via-white to-blue-50 p-8 lg:p-16 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-200/80 overflow-hidden">
        
        {/* Ambient Glows */}
        <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-blue-400/15 rounded-full blur-[140px] pointer-events-none" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-emerald-400/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative z-10 flex items-center justify-between">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[10px] text-blue-600 font-semibold tracking-wider uppercase">Enterprise Edition</p>
            </div>
          </div>
        ...
        <div className="relative z-10 my-auto py-12 max-w-lg">
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-full px-4 py-1.5 mb-6 backdrop-blur-md shadow-sm">
            <Sparkles size={14} className="text-blue-600" />
            <span className="text-xs font-semibold text-blue-700">Next-Gen Construction Intelligence</span>
          </div>
          ...
          <p className="text-slate-500 text-sm leading-relaxed mb-8">
            Access your secure workspace to oversee 2D canvas designs, real-time material takeoffs, and contractor milestones without budget overruns.
          </p>

          <div className="space-y-3.5">
            {[
              { icon: <Layers size={16} className="text-blue-600" />, text: "Real-time 2D floor plan generation & area calculations" },
              { icon: <Calculator size={16} className="text-emerald-600" />, text: "Automated BOQ and Sri Lankan material rate adjustments" },
              { icon: <ShieldCheck size={16} className="text-amber-600" />, text: "Bank-grade Stripe encrypted subscriptions & secure cloud storage" },
            ].map((feat, i) => (
      ...
      <div className="lg:w-1/2 bg-slate-50/50 flex flex-col items-center justify-center p-6 lg:p-16 relative">
        ...
        <div className="absolute w-[350px] h-[350px] bg-blue-500/5 rounded-full blur-[100px] pointer-events-none" />

        <div className="w-full max-w-md relative z-10">
          
          <div className="text-center mb-8 lg:hidden">
            <h3 className="text-xl font-bold text-slate-900 mb-1">Welcome Back</h3>
            <p className="text-slate-500 text-xs">Sign in to your BuildSure workspace</p>
          </div>

          {/* Frosted Glass Container for Clerk */}
          <div className="backdrop-blur-2xl bg-white/80 border border-slate-200/80 p-6 lg:p-8 rounded-3xl shadow-2xl shadow-slate-300/40">
            ...
            <div className="mb-6 pb-6 border-b border-slate-100">
              <span className="text-[10px] font-extrabold uppercase tracking-widest text-blue-600 block mb-1">Authentication Portal</span>
              <h3 className="text-lg font-bold text-slate-900">Sign In to Dashboard</h3>
              <p className="text-xs text-slate-500">Enter your credentials to manage your projects.</p>
            </div>
            ...
            <SignIn 
              ...
              appearance={{
                elements: {
                  ...
                  formFieldInput: 
                    "bg-white border border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 text-xs py-3",
                  formButtonPrimary: 
                    "bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-bold py-3 transition-all shadow-lg shadow-slate-900/20 hover:shadow-slate-900/30 mt-2",
                  ...
                  formResendCodeLink: "text-blue-600 text-xs",
                }
              }}
            />
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-slate-500 flex items-center justify-center gap-1.5">
              <CheckCircle2 size={14} className="text-emerald-500" /> Protected by 256-bit SSL Encryption
            </p>
          </div>
