...
function HomeownerDashboard() {
  ...
  // Fixed TypeScript error by casting user as any to safely check subscription metadata
  const isProUser = 
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 border-b border-slate-200 pb-6">
          <div>
            <div className="flex items-center gap-3">
              ...
              {isProUser && (
                <span className="bg-purple-100 text-purple-700 text-[10px] font-extrabold px-2.5 py-0.5 rounded-full uppercase tracking-wider border border-purple-200 shadow-xs">
                  PRO Workspace
                </span>
              )}
            </div>
            ...
            <div className="flex items-center gap-5 mb-8">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {isProUser && (
                    <span className="bg-purple-100 text-purple-700 text-[9px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wider">
                      PRO Subscriber
                    </span>
                  )}
                </div>
                <p className="text-xs text-slate-500 mt-0.5">{user?.email}</p>
                <p className="text-xs text-blue-600 font-semibold mt-1">Role: {(user as any)?.role}</p>
              </div>
            </div>
